      ...
      <div className="app-container pt-32">
        <div className="app-item app-item1 mr-12">
          ...
          <div className="app-guidcounter app-font font-semibold italic mt-32">
            <p className="text-grey-darker">So Far, <span className="text-blue font-bold text-3xl">2,203</span> GUIDs Created</p>
          </div>
        </div>
            ...
            <form className="app-form bg-white shadow-md rounded">
              <div className="app-form-container px-8 pt-6 pb-8 mb-3">
                ...
                <div className="mb-3">
                  ...
                  <input className="bg-grey-lighter appearance-none border-2 border-grey-lighter rounded w-full py-2 px-4 text-grey-darkest leading-loose focus:outline-none focus:bg-white focus:border-blue" id="amount" name="amount" type="text" placeholder="Number of GUIDs..." />
                </div>
